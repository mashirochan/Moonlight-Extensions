                        ...
                        >
                           {(thumbSrc || data.thumbnail) && (
                              <div style={{ position: "relative", display: "inline-block" }}>
                                 <img
                                    ...
                                    onClick={() =>
                                       window.open(`https://www.xivmodarchive.com/modid/${modId}`, "_blank")
                                    }
                                 />
                                 {(data.nsfw || data.nsfl) && (
                                    <div
                           ...
                           <div style={{ flex: 1, display: "flex", width: "100%" }}>
                              <div style={{ display: "flex", flexDirection: "column", width: "33%" }}>
                                 ...
                                 <div style={{ fontSize: 12 }}>
                                    {new Date(parseInt(data?.time_published))?.toLocaleDateString() ?? "Unknown"}
                                 </div>
                              </div>
                              <div style={{ display: "flex", flexDirection: "column", width: "33%" }}>
                                 <div style={{ fontSize: 12, fontWeight: 600 }}>Release Date</div>
                                 <div style={{ fontSize: 12 }}>
                                    {new Date(parseInt(data?.time_version_updated))?.toLocaleDateString() ?? "Unknown"}
                                 </div>
                              </div>
                              <div style={{ display: "flex", flexDirection: "column", width: "33%" }}>
